...
Public Class Prehlad
    ...
    Private Sub DataGridView1_CellContentClick(sender As System.Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        If e.RowIndex = -1 Then
            Exit Sub
        End If
        If e.ColumnIndex = 8 Then ' Vyrobit
            Me.riadok = e.RowIndex
            'If IsDBNull(DataGridView1.Rows(riadok).Cells(6).Value) Then
            ...
            'End If
        ElseIf e.ColumnIndex = 10 Then  ' Upravit
            Dim f As New Pridat_CP()
            f.cp = DataGridView1.Rows(e.RowIndex).Cells(0).Value
            f.ShowDialog()
            f.Dispose()
            Me.CPTableAdapter.Fill(Me.RotekDataSet.CP)
        ElseIf e.ColumnIndex = 11 Then ' Vyrobit zakazaku
        ...
        ElseIf e.ColumnIndex = 12 Then ' Zmazat
        ...
        ElseIf e.ColumnIndex = 15 Then ' Duplikuj
            duplikuj(e.RowIndex)
