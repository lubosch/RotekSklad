namespace GemBox.Spreadsheet
{
    ...
    public sealed class CellStyle
    {
        ...
        public CellStyle()
        {
            this.element = new CellStyleData(null, false, "Arial", 200);
        }
        ...
        public CellStyle(ExcelFile ef)
        {
            this.element = new CellStyleData(null, false, ef.DefaultFontName, ef.DefaultFontSize);
        }
